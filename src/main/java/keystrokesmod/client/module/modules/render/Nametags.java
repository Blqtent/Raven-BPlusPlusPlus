...
public class Nametags extends Module {
    ...
    public Nametags() { //TODO: Add Quantum's Nametags (this module is temporary and will be revamped in the future DO NOT WORK ON THIS)
    ...
    public void onForgeEvent(ForgeEvent fe) {
        if (fe.getEvent() instanceof Pre) {
            ...
            if (e.entity instanceof EntityPlayer && e.entity != mc.thePlayer && e.entity.deathTime == 0) {
                ...
                float distance = mc.thePlayer.getDistanceToEntity(en) / 4F;
                float scale;
                scale = (distance / 150F) * 2F;
                if (mc.thePlayer.getDistanceToEntity(en) > 6F) {
                    glScalef((float) (-scale * 1.077), (float) (-scale * 1.077), (float) (scale * 1.077));
                } else {
